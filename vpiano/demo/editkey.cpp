...
void EditKey::focusOutEvent(QFocusEvent * e)
{
    this->setText(_combinaison);
    emit(combinaisonChanged(QKeySequence(_combinaison)));
...
void EditKey::setCombinaison(const QKeySequence &sequence)
{
    _combinaison = sequence.toString();
    QLineEdit::setText(_combinaison);
}

QKeySequence EditKey::getSequence()
{
